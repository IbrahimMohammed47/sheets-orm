...
import { InsertInput, SheetCols, SheetFieldKinds } from "./schema";
...
(async function () {
    ...
    await clientUserModel.findMany({
        filters: {
            birthDate: { after: new Date("2025-02-08 19:44:43.042") },
            // OR: [{ age: { lt: 34 } }],
        },
        selections: [],
        limit: 12,
